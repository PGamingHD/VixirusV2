...
client.on("channelDelete", async (channel) => {
    if (await client.channelDelete.has(`${channel.guild.id}`) && await client.loggingmodule.has(`${channel.guild.id}`)) {
        if (channel.type === 0) {
            try {
            ...
            await LoggerLog(channel.guild, {
                embeds: [
                    ...
                    .setTitle(`:warning: Text Channel Deleted :warning:`) 
                    .addFields([{
                        name: 'Channel Name',
                        value: `${channel.name}`
                    }, {
            ...
            await LoggerLog(channel.guild, {
                embeds: [
                    new EmbedBuilder()
                    .setColor(ee.errorColor)
                    .setTitle(`:warning: Category Channel Deleted :warning:`) 
                    .addFields([{
                        name: 'Category Name',
                        value: `${channel.name}`
                    }, {
            ...
            await LoggerLog(channel.guild, {
                embeds: [
                    new EmbedBuilder()
                    .setColor(ee.errorColor)
                    .setTitle(`:warning: Stage Channel Deleted :warning:`) 
                    .addFields([{
                        name: 'Stage Name',
                        value: `${channel.name}`
                    }, {
            ...
            await LoggerLog(channel.guild, {
                embeds: [
                    new EmbedBuilder()
                    .setColor(ee.errorColor)
                    .setTitle(`:warning: Voice Channel Deleted :warning:`)
                    .addFields([{
                        name: 'VC Name',
                        value: `${channel.name}`
                    }, {
            ...
            await LoggerLog(channel.guild, {
                embeds: [
                    new EmbedBuilder()
                    .setColor(ee.errorColor)
                    .setTitle(`:warning: Announcements Channel Deleted :warning:`) 
                    .addFields([{
                        name: 'Channel Name',
                        value: `${channel.name}`
                    }, {
